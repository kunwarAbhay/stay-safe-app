...
const tabsListStyle = tva({
  base: "flex flex-grow relative z-10 bg-muted p-1 rounded-lg w-full",
  variants: {
    orientation: {
      horizontal: "flex-row",
      vertical: "flex-col",
...
const tabsTriggerStyle = tva({
  base: "flex-1 justify-center relative z-30 items-center web:outline-none data-[disabled=true]:opacity-40 data-[focus-visible=true]:web:ring-2 data-[focus-visible=true]:web:ring-primary/20 px-3 py-1.5 flex-row gap-1",
  parentVariants: {
    variant: {
      underlined: "",
      filled: "rounded-lg",
